...
import cst8218.pike0040.appuser.AppUserFacade;
import cst8218.pike0040.util.JsfUtil;
...
@DeclareRoles({"Admin","RestGroup","JsfGroup"})  //this doesn't work
@RolesAllowed({"Admin"})                        //this doesn't work
...
public class AppUserController implements Serializable {
    ...
    @EJB
    private cst8218.pike0040.appuser.AppUserFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/BundleAppUser").getString("AppUserCreated"));
            return prepareCreate();
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/BundleAppUser").getString("PersistenceErrorOccured"));
            return null;
        }
    }
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/BundleAppUser").getString("AppUserUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/BundleAppUser").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/BundleAppUser").getString("AppUserDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/BundleAppUser").getString("PersistenceErrorOccured"));
        }
    }
